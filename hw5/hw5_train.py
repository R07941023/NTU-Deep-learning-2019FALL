...
if __name__ == "__main__":
    pretrain = ''  # ./model/bi_LSTM/case2/36_model.pth
    data_set = 'hw5_training_token'  # hw5_training / hw5_testing
    output_path = './model/'  # model output: ./model/AE_rgb/
    ...
    folder_X, folder_Y, model_type = sys.argv[1], sys.argv[2], 'bi_LSTM'  # sys.argv[1], sys.argv[2]  TA_2018_Classifier, resnet152_1d
    folder_csv = sys.argv[4]
    testing_csv_path = sys.argv[3]
    # Get data loaders of training set and validation set
    train_set, val_set, train_loader, val_loader, vectors = get_dataloader( folder_X, folder_Y, data_set, train_proportion, batch_size, seed, embed_dim, wndw_size, word_cnt, word_iter, work_worker, seq_len, testing_csv_path)
